...
INSERT INTO YCMSHOPSERVICE (id, service_price, service_type, currency, timing_hours, service_description) VALUES (3,'800.0',9,0,'1.0','Engine cleaning');
INSERT INTO YCMSHOP (nick, email, role, address_id, shop_name) VALUES ('shopOne','rp@gmail.com',2,2,'ONE SHOP');
INSERT INTO  YCMCUSTOMERSERVICE(id, service_type, service_description,service_price, currency, service_appointment_day, ycmcustomer_id, service_hour, shop_id) VALUES (1, 9, 'Change motor oil with oil filter','500', 0, '30-SEP-2022',1, '16:00', 1);
INSERT INTO  YCMCUSTOMERSERVICE(id, service_type, service_description,service_price, currency, service_appointment_day, ycmcustomer_id, service_hour, shop_id) VALUES (2, 9, 'Replacement of spark plug candles','300', 0,'30-SEP-2022',2, '16:30', 1);
INSERT INTO  YCMCUSTOMERSERVICE(id, service_type, service_description,service_price, currency, service_appointment_day, ycmcustomer_id, service_hour, shop_id) VALUES (3, 9, 'Engine cleaning','800', 0,'30-SEP-2022',1, '17:00', 1);
